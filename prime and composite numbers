...
o=1
while o>0:
    print("---------------","Choose any option from the following given below:",'\n',"0. Exit",'\n',"1. Print List of Prime Numbers",'\n',"2. Print List of Composite Number",'\n',"3. How many prime and composite numbers are in the given range? ","\n")
